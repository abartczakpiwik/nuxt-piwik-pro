...
const pageData = {
  ...
  description: "Content Tracking lets you track custom events not defined in rest of methods.",
  methods: [
    {
      method: "trackEvent",
      usage: "$piwikPRO.CustomEvent.trackEvent(category: string, action: string, name?: string | undefined, value?: number | undefined): void",
