...
const pageData = {
  ...
  description: "Goals let you define important actions registered in your application and track conversions when the conditions for the action are fulfilled.",
  methods: [
    {
      method: "trackGoal",
      usage: "$piwikPRO.GoalConversions.trackGoal(goalId: number | string, conversionValue: number, dimensions?: Object)",
